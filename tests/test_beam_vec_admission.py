...
class TestBitWidthFailureAndCacheIdentity:
    """CodeRabbit 3942332619: a bit store whose live width cannot be
    resolved (dim lookup raising) must abstain at recall level, and the
    enhanced-recall cache key must vary with the admission constant."""
